...
func init() {
	...
	Register(&SArgs{20, PA("epoll_create1", []PArg{A("flags", EXP_INT)})})
	...
	Register(&SArgs{24, PA("dup3", []PArg{A("oldfd", INT), A("newfd", UINT64), A("flags", EXP_INT)})})
	...
	Register(&SArgs{75, PA("vmsplice", []PArg{A("fd", EXP_INT), A("uiov", POINTER), A("nr_segs", INT), A("flags", EXP_INT)})})
	...
	Register(&SArgs{206, PA("sendto", []PArg{A("sockfd", EXP_INT), A("buf", READ_BUFFER_T), A("len", INT), A("flags", EXP_INT), A("dest_addr", SOCKADDR), A("addrlen", INT)})})
	Register(&SArgs{207, PA("recvfrom", []PArg{A("sockfd", EXP_INT), B("buf", WRITE_BUFFER_T), A("len", INT), A("flags", EXP_INT)})})
	...
	Register(&SArgs{211, PA("sendmsg", []PArg{A("sockfd", EXP_INT), A("msg", MSGHDR), A("flags", EXP_INT)})})
	Register(&SArgs{212, PA("recvmsg", []PArg{A("sockfd", EXP_INT), B("msg", MSGHDR), A("flags", EXP_INT)})})
	...
	Register(&SArgs{242, PA("accept4", []PArg{A("sockfd", EXP_INT), A("addr", SOCKADDR), A("addrlen", INT), A("flags", EXP_INT)})})
	...
	Register(&SArgs{270, PA("process_vm_readv", []PArg{A("pid", INT), B("local_iov", POINTER), A("liovcnt", INT), B("remote_iov", POINTER), A("riovcnt", INT), A("flags", EXP_INT)})})
	Register(&SArgs{271, PA("process_vm_writev", []PArg{A("pid", INT), A("local_iov", POINTER), A("liovcnt", INT), A("remote_iov", POINTER), A("riovcnt", INT), A("flags", EXP_INT)})})
