...
func init() {
	...
	Register(&SArgs{7, PA("fsetxattr", []PArg{A("fd", EXP_INT), A("name", STRING), A("value", POINTER), A("size", INT), A("flags", INT)})})
	...
	Register(&SArgs{21, PA("epoll_ctl", []PArg{A("epfd", INT), A("op", INT), A("fd", EXP_INT), A("event", EPOLLEVENT)})})
	...
	Register(&SArgs{65, PA("readv", []PArg{A("fd", EXP_INT), B("iov", POINTER), A("iovcnt", INT)})})
	Register(&SArgs{66, PA("writev", []PArg{A("fd", EXP_INT), A("iov", POINTER), A("iovcnt", INT)})})
	// Register(&SArgs{66, PA("writev", []PArg{A("fd",EXP_INT), A("iov", IOVEC_T_PTR), A("iovcnt", INT)})})
	...
	Register(&SArgs{69, PA("preadv", []PArg{A("fd", EXP_INT), B("iov", POINTER), A("iovcnt", INT), A("offset", INT)})})
	Register(&SArgs{70, PA("pwritev", []PArg{A("fd", EXP_INT), A("iov", POINTER), A("iovcnt", INT), A("offset", INT)})})
	...
	Register(&SArgs{75, PA("vmsplice", []PArg{A("fd", EXP_INT), A("uiov", POINTER), A("nr_segs", INT), A("flags", INT)})})
	...
	Register(&SArgs{84, PA("sync_file_range", []PArg{A("fd", EXP_INT), A("offset", INT), A("nbytes", INT), A("flags", INT)})})
	Register(&SArgs{85, PA("timerfd_create", []PArg{A("clockid", INT), A("flags", INT)})})
	Register(&SArgs{86, PA("timerfd_settime", []PArg{A("fd", EXP_INT), A("flags", INT), A("new_value", ITIMERSPEC), A("old_value", ITIMERSPEC)})})
	...
	Register(&SArgs{203, PA("connect", []PArg{A("sockfd", EXP_INT), A("addr", SOCKADDR), A("addrlen", INT)})})
	Register(&SArgs{204, PA("getsockname", []PArg{A("sockfd", EXP_INT), B("addr", SOCKADDR), A("addrlen", INT)})})
	Register(&SArgs{205, PA("getpeername", []PArg{A("sockfd", EXP_INT), B("addr", SOCKADDR), A("addrlen", INT)})})
	Register(&SArgs{206, PA("sendto", []PArg{A("sockfd", EXP_INT), A("buf", READ_BUFFER_T), A("len", INT), A("flags", INT), A("dest_addr", SOCKADDR), A("addrlen", INT)})})
	Register(&SArgs{207, PA("recvfrom", []PArg{A("sockfd", EXP_INT), B("buf", WRITE_BUFFER_T), A("len", INT), A("flags", INT)})})
	Register(&SArgs{208, PA("setsockopt", []PArg{A("sockfd", EXP_INT), A("level", INT), A("optname", INT), A("optval", INT), A("optlen", INT)})})
	Register(&SArgs{209, PA("getsockopt", []PArg{A("sockfd", EXP_INT), A("level", INT), A("optname", INT), B("optval", INT), A("optlen", POINTER)})})
	Register(&SArgs{210, PA("shutdown", []PArg{A("sockfd", EXP_INT), A("how", INT)})})
	Register(&SArgs{211, PA("sendmsg", []PArg{A("sockfd", EXP_INT), A("msg", MSGHDR), A("flags", INT)})})
	Register(&SArgs{212, PA("recvmsg", []PArg{A("sockfd", EXP_INT), B("msg", MSGHDR), A("flags", INT)})})
	Register(&SArgs{213, PA("readahead", []PArg{A("fd", EXP_INT), A("offset", INT), A("count", INT)})})
	...
	Register(&SArgs{222, PA("mmap", []PArg{B("addr", POINTER), A("length", INT), A("prot", INT), A("flags", INT), A("fd", EXP_INT), A("offset", INT)})})
	...
	Register(&SArgs{226, PAI("mprotect", []PArg{A("addr", POINTER), A("length", INT), A("prot", INT)})})
	...
	Register(&SArgs{242, PA("accept4", []PArg{A("sockfd", EXP_INT), A("addr", SOCKADDR), A("addrlen", INT), A("flags", INT)})})
	Register(&SArgs{243, PA("recvmmsg", []PArg{A("fd", EXP_INT), A("mmsg", POINTER), A("vlen", INT), A("flags", INT), A("timeout", TIMESPEC)})})
	...
	Register(&SArgs{268, PA("setns", []PArg{A("fd", EXP_INT), A("flags", INT)})})
	Register(&SArgs{269, PA("sendmmsg", []PArg{A("fd", EXP_INT), A("mmsg", POINTER), A("vlen", INT), A("flags", INT)})})
	...
	Register(&SArgs{273, PA("finit_module", []PArg{A("fd", EXP_INT), A("uargs", STRING), A("flags", INT)})})
	...
	Register(&SArgs{286, PA("preadv2", []PArg{A("fd", EXP_INT), A("vec", POINTER), A("vlen", INT), A("pos_l", INT), A("pos_h", INT), A("flags", INT)})})
	Register(&SArgs{287, PA("pwritev2", []PArg{A("fd", EXP_INT), A("vec", POINTER), A("vlen", INT), A("pos_l", INT), A("pos_h", INT), A("flags", INT)})})
	...
	Register(&SArgs{424, PA("pidfd_send_signal", []PArg{A("pidfd", INT), A("sig", INT), A("info", SIGINFO), A("flags", INT)})})
	Register(&SArgs{425, PA("io_uring_setup", []PArg{A("entries", INT), A("params", POINTER)})})
	Register(&SArgs{426, PA("io_uring_enter", []PArg{A("fd", EXP_INT), A("to_submit", INT), A("min_complete", INT), A("flags", INT), A("argp", POINTER), A("argsz", INT)})})
	...
	Register(&SArgs{436, PA("close_range", []PArg{A("fd", EXP_INT), A("max_fd", INT), A("flags", INT)})})
	Register(&SArgs{437, PA("openat2", []PArg{A("dfd", INT), A("filename", STRING), A("how", POINTER), A("usize", INT)})})
	Register(&SArgs{438, PA("pidfd_getfd", []PArg{A("pidfd", INT), A("fd", EXP_INT), A("flags", INT)})})
